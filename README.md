...
- Поиск линий разметки с помощью цветового фильтра (переводим картинку в цветовое пространство HSL и ищем белые и желтые полосы).
![Desc](explain/img1.png)
- Поиск границы найденных линий с помощью адаптивного трешхолда.
